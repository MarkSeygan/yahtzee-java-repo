...
/**
 * ScoreTable takes care about the main JTable and all the methods to show possible combinations and their actual possible score,
 *  to Fill in the desired combination, to update sums and check bonuses. The methods aren't much commented, because their name describes them good and they aren't much complicated.
 *
 * @author Marek Zidek
 */
